# Installing Julia & DeepRecurrentEncoder.jl
...
## Installing DeepRecurrentEncoder.jl
...
Before installing DeepRecurrentEncode.jl make sure that you activated your project environment.
...
#### 3. Install the DeepRecurrentEncoder.jl package
- If you are not in the package manager anymore, type `]`.
- Then type `add DeepRecurrentEncoder`.

After the installation is finished you can use `using DeepRecurrentEncoder` in the REPL to import the package.